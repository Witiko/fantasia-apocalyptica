...
\begingroup
% TODO: Odstraň a místo toho vypiš přímo v textu hodnotu pro obrázek u verše 21:08.
% TODO: Všechny následující příklady v této sekci ilustruj na tomto obrázku místo obrázku `ilustrace/004.png`.
\small
\begin{verbatim}
...
\section{Závěr}
\label{sec:zaver}
% TODO: Popsat promítání videozáznamu 18. prosince 2019 včetně popisu plakátu a nahánění studentů z haly za zvuku PC speakerů. https://gitlab.fi.muni.cz/unix/beeplay/-/commits/master/?ref_type=HEADS
