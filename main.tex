...
\vspace{-15pt}
\begin{abstract}
11. října 2019 se při příležitosti oslav 25. výročí založení Fakulty informatiky Masarykovy univerzity uskutečnila česká premiéra multimediálního díla ,,Fantasia Apocalyptica`` za osobní účasti autora, Donalda Knutha. Z představení byl pořízen záznam, který je veřejně dostupný na kanálu YouTube Fakulty informatiky.
\oldlooseness=-1
